...
module.exports = (function () {
     ...
     * @property {String[]} branches ___reference___ to {@link BranchModel}
     * @property {Boolean} isOwn For price survey
     * @property {Boolean} isArchived Is Outlet archived or not
