...
module.exports = (function () {
    ...
    var personnelSchema = new mongoose.Schema({
        ...
        phoneNumber: {type: String, default: '', unique: true, required: true},
    ...
    mongoose.model(CONSTANTS.PERSONNEL, personnelSchema);

    if (!mongoose.Schemas) {
        mongoose.Schemas = {};
    }

    mongoose.Schemas[CONSTANTS.PERSONNEL] = personnelSchema;
})();