define([
    ...
    function (dataService) {
        ...
        var utcDateToLocaleDate = function (utcDateString) {
            utcDateString = (utcDateString) ? moment(utcDateString, "D MMM, YYYY", false) : null;
            return utcDateString;

        }

        var utcDateToLocaleFullDateTime = function (utcDateString) {
            utcDateString = (utcDateString) ? moment(utcDateString, "DDDD, D MM YYYY HH:MM:s ZZ", false) : null;
            return utcDateString;
        }

        var utcDateToLocaleDateTime = function (utcDateString, notHours) {
            if (!notHours) {
                utcDateString = (utcDateString) ? moment(utcDateString, "D/M/YYYY HH:MM", false) : null;
            } else {
                utcDateString = (utcDateString) ? moment(utcDateString, "D/M/YYYY", false) : null;
            }
            return utcDateString;
        }
